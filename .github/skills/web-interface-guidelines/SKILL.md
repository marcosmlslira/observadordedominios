...
description: Concise, opinionated rules for building accessible, fast, and delightful web UIs. Covers interactions, animations, layout, accessibility, performance, dark mode, hydration, and design. Source: Vercel Labs — Web Interface Guidelines (https://github.com/vercel-labs/web-interface-guidelines). Use when building or reviewing any frontend component, page, or interaction pattern.
license: MIT
compatibility: Next.js, React, TypeScript, Tailwind CSS
metadata:
...
> Source: [vercel-labs/web-interface-guidelines](https://github.com/vercel-labs/web-interface-guidelines/blob/main/AGENTS.md)
...
- SHOULD: `translate="no"` on brand names, code tokens, & identifiers
